...
$(document).ready(function () {
    ...
    $('#GoToHome, #GoToAbout, #GoToFeatures, #GoToPromises, #GoToWorks, #GoToTeam, #GoToPricing, #GoToBlog, #GoToContacts').scrollTo({speed: 1400});
...
$(document).ready(function () {
    ...
    $("a[class^='prettyPhoto']").prettyPhoto({allow_expand: false});
...
$(document).ready(function () {
    ...
    $("#contact-form").validate({
        ...
        messages: {
            subject: {
                minlength: "Merci de saisir plus de 4 caractères",
                maxlength: "Merci de saisir moins de 24 caractères"
            },
            first_name: {
                required: "Merci de saisir plus d'un caractère"
            },
            email: {
                required: "Nous avons besoin de votre adresse email pour vous contacter",
                email: "Votre adresse email doit être au format nom@domaine.fr"
            }
        }
    });
...
var defaultTextareaValue = "Bonjour !\n" +
    "\n" +
    "En retour de ce message, « Comment bien briefer son agence ? » vous sera envoyé en format pdf !\n" +
    "\n" +
    "Merci de l’intérêt que vous portez à Concepto et à bientôt pour un prochain échange.\n" +
    "\n" +
    "Bien cordialement,\n" +
    "\n" +
    "L’équipe Concepto";

document.querySelector('textarea').value = defaultTextareaValue;

document.querySelector('textarea').onclick = function () {
    if (document.querySelector('textarea').value === defaultTextareaValue) {
        this.value = '';
    }
}
...
document.querySelector('textarea').onblur = function () {
    if (document.querySelector('textarea').value === '') {
        this.value = defaultTextareaValue;
    }
}
